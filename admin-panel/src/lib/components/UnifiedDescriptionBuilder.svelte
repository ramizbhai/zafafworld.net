<script lang="ts">
  ...
  import { BuilderState } from "$lib/features/admin/builder/builderState.svelte.js";
  import StepBaseInfo from "$lib/components/admin/builder/StepBaseInfo.svelte";
  import StepFeatures from "$lib/components/admin/builder/StepFeatures.svelte";
  import StepMedia from "$lib/components/admin/builder/StepMedia.svelte";
  import StepPreview from "$lib/components/admin/builder/StepPreview.svelte";
