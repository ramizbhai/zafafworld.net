import { z } from 'zod';
import { baseInfoSchema, type Block } from '$lib/shared/builder/builder.schema.js';
import { triggerUpgrade } from "$lib/stores/upgradeStore.js";

export class ClientBuilderState {
    // Current Wizard Step
    currentStep = $state(1);
    totalSteps = 4;
