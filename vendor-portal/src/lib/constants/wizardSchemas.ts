...
export function getSchemaForCategory(categoryId: string): CategorySchema | null {
    ...
    // 11, 12, 13. Venue Categories (restaurant-event, outdoor-garden, rooftop-venue, private-beach, villa-resort, hotel-venue, wedding-palace, chalet)
    const venueCategories = ['restaurant-event', 'outdoor-garden', 'rooftop-venue', 'private-beach', 'villa-resort', 'hotel-venue', 'wedding-palace', 'chalet'];
